...
export const MedicalProcedure = ({ global, service }) => {
                ...
                <Button
                  ...
                  onClick={() => {
                    if (isEqual(initialFilters, filters)) {
                      ...
                      service
                        .post(
                          'report.medicalprocedures',
                          { ...dbFilters, isPdf: true },
                          undefined,
                          resp => resp.blob(),
                        )
                        .then(blob => iframeDownload(blob, 'procedimentos.pdf'))
                ...
                <Button
                  ...
                  onClick={() => {
                    if (isEqual(initialFilters, filters)) {
                      ...
                      setFetching(true)
                      service
                        .post('report.medicalprocedures', {
                          ...dbFilters,
                        })
                        .then(resp => {
                          setItems(resp.medicalProcedures)
                        })
                        .catch(err => global.modal.alert(err.message))
                        .finally(() => setFetching(false))
                    }
