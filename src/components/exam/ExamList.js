...
export const disableExam = ({ modal, data: { id, description, disabledAt }, callback, service }) =>
  modal.confirm(
...
export const ExamList = ({ global, route, service, basename }) => {
  const { modal } = global
      ...
      <div className="kt-portlet kt-portlet--mobile">
          ...
          <div className="kt-portlet__head-toolbar">
            <div className="kt-portlet__head-wrapper">
              <div className="dropdown dropdown-inline">
                <Link className="btn btn-success btn-icon-sm" to={`${basename}/exames/cadastro`}>
                  <i className="fas fa-plus" /> Novo Exame
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="kt-portlet__body kt-portlet__body--fit">
          ...
          <List
            ...
            getItems={(query, signal) => service.getList('exam', query, signal)}
            actions={[
              {
                icon: 'fas fa-edit',
                title: 'Editar',
                action: `${basename}/exames/:id`,
              },
              {
                icon: 'fas fa-lock',
                title: 'Desabilitar',
