...
export const ProceduresModal = ({ service, show, onClose, onSelect }) => {
              ...
              <div role="document" className="modal-dialog modal-dialog-centered modal-xl">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title">Procedimentos</h5>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                if (values.description === '') {
                                  setError(
                                    'Para busca de procedimentos, informe ao menos uma descrição.',
                                  )
                                } else {
                                  setError(null)
                                  setFetching(true)
                                  service
                                    .getList('medicalprocedure', {
                                      usePager: false,
                                      filters: dbFilters,
